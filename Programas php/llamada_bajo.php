...
$extension1 = "100";
$audioFile1 = "/var/lib/asterisk/sounds/Atencion-Niveles-bajo";
...
$extension2 = "101";
$audioFile2 = "/var/lib/asterisk/sounds/Atencion-Niveles-bajo";
...
$messageData = [
    'message' => 'Llamadas a Asterisk por niveles bajos de sensores realizadas a las extensiones ' . $extension1 . ' y ' . $extension2 . ' con reproducción de audio'
];
...
echo "Llamadas a Asterisk por niveles bajos de sensores realizadas a las extensiones $extension1 y $extension2 con reproducción de audio\n";
?>
